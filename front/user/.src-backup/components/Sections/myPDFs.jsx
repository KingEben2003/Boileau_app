  ...
  return (
    <>
      ...
      <motion.aside
        ...
        style={{ width }}
        className="fixed lg:static right-0 top-0 h-screen glass-panel p-6 flex flex-col gap-6 z-50 border-l border-white/10"
      >
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-black tracking-tight text-white">Mes Documents</h3>
        ...
        <button className="w-full py-3 bg-white/5 border border-dashed border-white/20 rounded-2xl text-sm font-bold text-gray-400 hover:text-white hover:border-white/40 hover:bg-white/10 transition-all flex items-center justify-center gap-2 group">
