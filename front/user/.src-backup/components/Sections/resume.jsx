    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-white tracking-tight">Résumé Intelligent</h2>
            <p className="text-sm text-gray-500">Extraction des points clés via Gemini AI</p>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <button className="p-3 rounded-xl bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-all border border-white/10">
            <FiShare2 size={18} />
          </button>
          <button
            onClick={handleDownload}
            disabled={!summary}
            className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-lg shadow-indigo-500/20 transition-all active:scale-[0.98] flex items-center gap-2 text-sm"
          >
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        <span className="text-xs font-black uppercase tracking-widest text-indigo-400 flex items-center gap-2 mr-2">
          <FiStar size={13} fill="currentColor" /> Type
        </span>
