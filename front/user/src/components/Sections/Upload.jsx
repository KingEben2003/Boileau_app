        ...
        {activeMode === null ? (
          ...
          >
            ...
            >
              ...
              <h2 className="text-fluid-2xl font-black mb-3 tracking-tight text-gradient-soft">
                Transformez vos PDFs<br className="hidden sm:block" /> en savoir actionnable.
              </h2>
              <p className="text-gray-400 text-fluid-base max-w-md mx-auto leading-relaxed">
            ...
            <motion.div
              ...
              className="glass-panel p-5 sm:p-8 rounded-[2rem]"
            >
